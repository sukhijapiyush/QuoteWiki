					...
					<fieldset>
						...
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-6">
								<input type="submit" name="Submit" value="Login" class="btn btn-lg btn-success btn-block"> </div>
						</div>
					</fieldset>
				</form>
			</div>
...
// here check the submitted text box for null value by giving there name.
	...
	{
	   $sql1= "select * from login where username= '".$_REQUEST['user_id']."' &&  password ='".$_REQUEST['password']."'";
...
//here you can redirect on your file which you want to show after login just change filename ,give it to your filename.
 ...
 //OR just simply print a message.
                header("location:Resultpage/loginsuccess.html");	
  
	   }
	    else
		{
			         header("location:Resultpage/loginfail.html");	
